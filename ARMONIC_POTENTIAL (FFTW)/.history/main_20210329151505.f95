PROGRAM Use_fftw
    ...
    IMPLICIT NONE    
    ! 
    integer :: plan     ! il prof usa integer fa facciamo un po' a caso... tanto cosa cambia 
    integer ::   N, M, F, i   
    INTEGER,PARAMETER :: UnitRead = 11
    CHARACTER(LEN = 50) :: FileInput = "Input.txt"
    DOUBLE PRECISION:: L,h                                        
    DOUBLE PRECISION,dimension(:),ALLOCATABLE:: in,x           ! allochiamo le variabili secondo 
