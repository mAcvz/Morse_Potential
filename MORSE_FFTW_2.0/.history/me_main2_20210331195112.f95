program  me_main2
    ...
    real(kind=dp),dimension(0:N-1),allocatable :: x 
    complex(kind=dp),dimension(0:N-1),allocatable :: in,out
    ...
    call dfftw_plan_dft_1d(plan,in,outFFTW_forward,fftw_estimate)
