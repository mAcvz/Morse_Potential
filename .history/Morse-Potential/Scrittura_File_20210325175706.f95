 MODULE Scrittura_File
    ...
    SUBROUTINE Scrittura_File_Autoval()      !!! scrittura AUTOVALORI
        ...
        !
        WRITE(*,"(A)") NEW_LINE("A")//"Anteprima autovalori:"//NEW_LINE("A")
        ...
        control_1: IF (ioerr .NE. 0) THEN
            ...
            !
        ELSE
            WRITE(*,*) NEW_LINE("A")//"AUTOVALORI STAMPATI CORRETAMENTE SUL FILE: " ,FileName_Autoval,NEW_LINE("A") ! Esito operazione
        END IF control_1
        !
    ...
    SUBROUTINE Scrittura_File_Autovet()  !!! scrittura AUTOVETTORI
        ...
        !
            ...
            WRITE(*,*) NEW_LINE("A")//"AUTOVETTORI STAMPATI CORRETAMENTE SUI FILE: ", name_end                    ! Esito operazione
        ELSE 
        !
