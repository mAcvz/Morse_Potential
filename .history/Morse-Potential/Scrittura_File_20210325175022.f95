 MODULE Scrittura_File
    ...
    SUBROUTINE Scrittura_File_Autoval()      !!! scrittura AUTOVALORI
        ...
        !
        WRITE(*,"(A)") "Anteprima autovalori:"//NEW_LINE("A")
        ...
        control_1: IF (ioerr .NE. 0) THEN
            !
            PRINT NEW_LINE("A")"('ESITO SCRITTURA FILE AUTOVALORI : ioerr = ',i1,' ERRORE')",ioerr   ! Esito operazione
            !WRITE(*,*) NEW_LINE("A")//'ESITO SCRITTURA FILE AUTOVALORI : ioerr = ',i1,' ERRORE',ioerr         ! Esito
            !
        ELSE
            WRITE(*,*) "AUTOVALORI STAMPATI CORRETAMENTE SUL FILE: " ,FileName_Autoval  ! Esito operazione
        END IF control_1
        !
    ...
    SUBROUTINE Scrittura_File_Autovet()  !!! scrittura AUTOVETTORI
        ...
        !
            ...
            WRITE(*,*) "AUTOVETTORI STAMPATI CORRETAMENTE SUI FILE: ", name_end                    ! Esito operazione
        ELSE 
        !
